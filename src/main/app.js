...
define([ 'angular',
         ...
         'tmdb/directives/actorModal'], 
    function( angular, config, $resource, $location, LocalStorageModule, 
              TMDBAPIService, SearchController, HomeController, MovieController, ActorModalController, movieTrailerController,
              ...
              awesomeSearchResultsDirective, movieTrailerDirective, yearDirective, actorModalDirective ) {
    	"use strict";
        ...
        app.controller( "ActorModalController", ActorModalController);
        app.directive( "actorModal", actorModalDirective);
